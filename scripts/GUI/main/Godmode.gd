...
var godmodeInventory = {
	...
	"functional_blocks":[12,16,28,91,145,158,159,166,167,168,169,170,171,172,176,216,241,242,243,246,263,265,266,267,268,269,264,270,271,272,301,320,321,325,326,327],
